...
import molu.mq.idempotent.MessageQueueIdempotentHandler;
...
import static molu.common.constant.RedisKeyConstant.LOCK_GID_UPDATE_KEY;
...
public class ShortLinkStatsSaveConsumer implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    public void onMessage(MapRecord<String, String, String> message) {
        ...
        if(!messageQueueIdempotentHandler.isMessageProcessed(id.toString())){
            ...
            throw new ServiceException("监控日志消息未完成流程，需消息队列重试");
        }
        try {
    ...
    public void actualSaveShortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            var linkOsStatsDO = LinkOsStatsDO.builder()
